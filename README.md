# 全网最硬核、方向最全面、最经典、最新的40多个计算机软件开发电子书大全（1000多本电子书免费下载）
### [一、初衷:](#fz) <a id="fz" > 网上下电子书经常电脑中毒，这不搜集1000多本硬核电子书，为大家提供服务，目前由我一人维护，后续一定会持续更新，让内容更加丰富饱满，看到如此辛苦给我个[**star**](#star) <a id="star" ></a> 吧！</a>

### [二、简介:](#jj) <a id="jj" > 目前涉及方向有C/C++、php、Go、C#、python、R、kotlin、java、java服务端、前端、小程序、uniapp、跨平台、Android/ios、数据结构和算法、面试、linux入门、linux c/c++服务端、嵌入式、运维、linux内核、linux驱动、底层操作系统、计算机网络、设计模式、数据库、大数据、云计算、区块链、windows开发、游戏开发、安全与逆向、并发编程、架构设计、重构优化、鸿蒙系统开发、AI、机器学习、深度学习、matlab、计算机视觉、数据挖掘、自然语言处理、数字图像处理、机器人开发等主流开发[**40**](#40) <a id="40" ></a>多个硬核方向。</a>
...
+ [**编译原理（第2版）.pdf**](#rhhqzl)                                                                     
+ [**计算机组成与设计：硬件、软件接口（第4版）.pdf**](#rhhqzl) 
+ [**操作系统：精髓与设计原理（中文第七版）_扫描版_21.1M.pdf**](#rhhqzl) 
...
+ [**IDA Pro权威指南（第2版）.pdf**](#rhhqzl)                                                        
+ [**iOS应用逆向工程(第2版) (1).pdf**](#rhhqzl)                                                      
+ [**Kali Linux无线渗透测试指南（第3版）.pdf**](#rhhqzl)                                                 
+ [**Linux二进制分析.pdf**](#rhhqzl)                                                              
+ [**OAuth 2实战.pdf**](#rhhqzl)                                                               
+ [**Web安全开发指南.pdf**](#rhhqzl)                                                               
+ [**Web渗透测试：使用Kali Linux.pdf**](#rhhqzl)                                                    
+ [**Wireshark数据包分析实战（第3版） (1).pdf**](#rhhqzl)                                               
+ [**Wireshark网络分析实战.pdf**](#rhhqzl)                                                         
+ [**[Android]应用安全防护和逆向分析.pdf**](#rhhqzl)                                                    
+ [**黑客攻防技术宝典：iOS实战篇.pdf**](#rhhqzl)                                                         
+ [**黑客攻防技术宝典：Web实战篇（第2版）.pdf**](#rhhqzl)                                                    
+ [**黑客攻防技术宝典：反病毒篇.pdf**](#rhhqzl)                                                           
+ [**黑客攻防技术宝典：浏览器实战篇.pdf**](#rhhqzl)                                                         
